...
public class CricketerDAOImpl implements CricketerDAO {
    ...
    public int addCricketer(Cricketer cricketer) {//throws SQLException {
        ...
        //     statement.setLong(2, cricketer.getCricketerId());
        ...
        //     statement.setInt(8, cricketer.getTotal_runs());
    ...
    public void updateCricketer(Cricketer cricketer) {//throws SQLException {
        ...
        // try {
        //     connection = DatabaseConnectionManager.getConnection();
        //     String sql = "UPDATE cricketer SET teamId = ?, cricketer_name = ?, age = ?, nationality = ?, experience = ?, role = ?, total_runs = ?, total_wickets = ? WHERE cricketer_id = ?";
        //     statement = connection.prepareStatement(sql);
        //     statement.setInt(1, cricketer.getTeamId());
        //     statement.setLong(2, cricketer.getCricketer_id());
        //     statement.setInt(3, cricketer.getAge());
        //     statement.setString(4, cricketer.getNationality());
        //     statement.setInt(5, cricketer.getExperience());
        //     statement.setString(6, cricketer.getRole());
        //     statement.setInt(7, cricketer.getTotal_runs());
        //     statement.setInt(8, cricketer.getTotal_runs());
        //     statement.setInt(9, cricketer.getCricketer_id());
        //     statement.executeUpdate();
        // } catch (SQLException e) {
        //     e.printStackTrace();
