...
public class MatchDAOImpl implements MatchDAO {
    ...
    public int addMatch(Match match) {//throws SQLException {
        ...
        //     statement.setInt(1, match.getFirst_team_id());
        //     statement.setInt(2, match.getSecond_team_id());
        //     statement.setDate(3, new java.sql.Date(match.getMatch_date().getTime()));
        //     statement.setString(4, match.getVenue());
        //     statement.setString(5, match.getResult());
        //     statement.setString(6, match.getStatus());
        //     statement.setInt(7, match.getWinner_team_id());
    ...
    public void updateMatch(Match match){//} throws SQLException {
        ...
        //     statement.setString(6, match.getStatus());
        //     statement.setInt(7, match.getWinner_team_id());
        //     statement.setInt(8, match.getMatch_id());
        //     statement.executeUpdate();
        // } catch (SQLException e) {
        //     e.printStackTrace();
        //     throw e;
